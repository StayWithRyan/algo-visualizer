...
function KMPInfo() {
    return (
        <>
            ...
            <TextItem>
                Попередньо проводиться дослідження зразока та для кожного його підрядка визначається префікс-суфікс-функція. 
            ...
            <TextItem tabs={1}>
                3. Перевірити чи збіється зразок за індексом j із текстом за індексом i, по черзі порівнявши всі символи.
            </TextItem>
            <TextItem tabs={1}>
