    ...
    return (
        <>
            ...
            <TextItem>
                ...
                що перший символ зразка не буде відповідати j відповідним символам тексту, оскільки всі його символи різні.
                Отже, ми завжди можемо перемістити шаблон на j, не пропускаючи жодних дійсних зрушень.
            </TextItem>
            <TextItem>
