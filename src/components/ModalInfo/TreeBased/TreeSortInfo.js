...
function TreeSortInfo() {
    return (
        <>
            <TextItem>
                Алгоритм полягає у створенні бінарного дерева пошуку - бінарне дерево, ключ у кожному вузлі якого більший за будь-який ключ, 
                що зберігається в лівому піддереві, і менший або дорівнює будь-якому ключу, що зберігається в правому піддереві.
            </TextItem>

            <TextItem>
                Якщо обійти дане дерево у змішаному порядку (змішаний обхід), ми отримаємо відсортований масив.
            </TextItem>
            
            <TextItem>
                Головним недоліком алгоритму є його нестабільність. 
                Складність додавання нової вершини у бінарне дерево пошуку варіюється від O(log(n)) до O(n),
            ...
            <TextItem>Покроковий опис додавання елемента у бінарне дерево пошуку:</TextItem>
            ...
            <TextItem tabs={2}>{`3. Якщо лівого сина немає, добавити його із значенням елемента та завершити алгоритм,
                інакше викликати даний алгоритм над лівим сином`
            }</TextItem>
            <TextItem tabs={2}>{`4. Якщо правого сина немає, добавити його із значенням елемента та завершити алгоритм,
                інакше викликати даний алгоритм над правим сином`
            }</TextItem>
