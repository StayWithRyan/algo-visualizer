...
function NLRTraversalInfo() {
    return (
        <>
            ...
            <TextItem>
                NLR - Node, Left, Right. Це підказка в назві алгоритму, яка вказує на порядок проходження дерева
            </TextItem>

            <HorizontalLine/>
            
            <TextItem>Покроковий опис низхідного обходу (На першому кроці поточна вершина - корінь дерева):</TextItem>
            <TextItem tabs={1}>{"1. Відвідати поточну вершину"}</TextItem>
            <TextItem tabs={1}>{"2. Якщо в поточної вершини є лівий син, рекурсивно виконати цей алгоритм для цієї вершини"}</TextItem>
