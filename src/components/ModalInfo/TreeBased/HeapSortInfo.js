...
function HeapSortInfo() {
    return (
        <>
            ...
            <TextItem>
                Щоб побудувати двійкову купу (яку також називають пірамідою, звідки й пішла назва алгоритму), розпочнемо з пустого дерева.
                По черзі кожен елемент масиву будемо добавляти у кінець дерева, викликаючи після цього процедуру просіювання вверх.
                Добавивши новий елемент в кінець дерева, ми ламаємо двійкову купу 
