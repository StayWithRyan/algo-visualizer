...
function BFSInfo() {
    return (
        <>
            <TextItem>
                Алгоритм пошуку у ширину починається з довільної вершини і здійснює обхід всіх сусідніх вершин до переходу на наступну вершину.
                Алгоритм має назву пошуку в ширину, оскільки хвиля пошуку одноманітно розширюється вздовж всієї своєї ширини.
                Тобто, алгоритм проходить всі вершини на відстані k перед тим як пройти вершини на відстані k+1.
            </TextItem>
            ...
            <TextItem>
                ...
                Проте, оскільки на даному полі всі ваги дорівнюють одиниці, дані алгоритми виглядають однаково. Ця сторінка - це опис виключно алгоритму пошуку у ширину.
            </TextItem>
