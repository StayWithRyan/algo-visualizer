...
function GeneralInfo() {
    ...
    return (
        <>
            ...
            <TextItem tabs={1}>Всі алгоритми пошуку потребують додаткової пам'яті, оскільки потрібно зберігати шлях просування.</TextItem>
            ...
            <TextItem tabs={1}>Ви можете згенерувати лабіринт. Генерація алгоритму триває декілька секунд, ви можете пропустити очікування,
