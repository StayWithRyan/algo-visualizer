...
function DFSInfo() {
    return (
        <>
            <TextItem>
                Алгоритм починається з довільної вершини і здійснює обхід в максимально можливу глибину до переходу на наступну вершину.
            </TextItem>
            ...
            <TextItem tabs={1}>{"2. Присвоїти current початкову вершину, з якої шукаємо шлях"}</TextItem>
            ...
            <TextItem tabs={1}>{`9. Алгоритм завершено, шляху не існує`}</TextItem>
        </>
    );
}
