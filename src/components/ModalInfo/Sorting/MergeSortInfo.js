    ...
    return (
        <>
            <TextItem>
                ...
                На кожній ітерації відбувається злиття двох упорядкованих ділянок масиву в одну впорядковану ділянку іншого масиву.
            </TextItem>
            ...
            <TextItem tabs={1}>{"S4. Рекурсивно виконати сортування лівої частини масиву: Розпочати даний алгоритм сортування з S2 кроку, прийнявши l = l; r = m"}</TextItem>
            <TextItem tabs={1}>{"S5. Рекурсивно виконати сортування правої частини масиву: Розпочати даний алгоритм сортування з S2 кроку, прийнявши l = m+1; r = r"}</TextItem>
